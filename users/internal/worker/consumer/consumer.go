...
type eventHandler func(ctx context.Context, svc *service.UsersService, data []byte) (string, error)
...
func NewConsumer(
	...
	return &Consumer{
		...
		handlers: map[string]eventHandler{
			...
			"identity.updated": handleIdentityUpdated,
			"identity.deleted": handleIdentityDeleted,
		},
	}
}
